...
|integer |minInclusive, minExclusive, maxInclusive, maxExclusive|Represents a sequence of decimal digits with an optional leading sign (+ or -). This data type is derived from decimal.|
